...
class LineParser:
    ...
    def parse(self, line):
        ...
        if not value:
            keys, value = self.__extract_keys_and_value(
                line, self.key_value_define_delimiters, True)
            append = False
    ...
    def __extract_keys_and_value(self,
        ...
        :param delimiters:            A list of delimiters to split the
                                      strings on.
        :param return_value_nonempty: If no delimiter is found and this is true
